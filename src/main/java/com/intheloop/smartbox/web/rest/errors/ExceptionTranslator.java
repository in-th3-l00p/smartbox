...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.intheloop.smartbox.service.EmailAlreadyUsedException ||
            ex instanceof com.intheloop.smartbox.service.UsernameAlreadyUsedException
        ) {
